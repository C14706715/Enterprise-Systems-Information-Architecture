	...
	public static void main(String[] args) {
		...
		try {
			...
			for(int i = 0; i < 17; i++)
			{
				...
				// Every four seconds send a message to the queue
				TextMessage textMessage = null;
				if(i % 4 == 0)
				{
					textMessage = mySess.createTextMessage();
					textMessage.setText("Hello World: Time Elapsed has been: " + i + " seconds.");

					System.out.println("\nSending message: " + textMessage.getText());
					myMsgProducer.send(textMessage);
				}
			}
			System.out.println();
